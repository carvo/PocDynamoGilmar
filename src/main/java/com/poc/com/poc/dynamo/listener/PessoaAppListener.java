...
//@Component
public class PessoaAppListener implements ApplicationListener<ApplicationReadyEvent> {

	@Autowired
	private PessoaRepository repository;

	private static final Logger log = LoggerFactory.getLogger(PessoaAppListener.class);
	...
	public void onApplicationEvent(ApplicationReadyEvent event) {
		try {
			...
			log.info("Registros iguais {}", ultimo.equals(entity));
